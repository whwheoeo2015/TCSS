 ...
 * <p>
 * Invariant: <br>
 * myRadius must be greater than zero <br>
 * AND myCenter must not be null <br>
...
public class Circle {
    ...
    /**
     * A default radius to use when no other value is specified - (1.0 - a unit
     * circle).
     */
    private static final double DEFAULT_RADIUS = 1.0; // unit circle

    /**
     * A default Point for the center of a Circle - (0.0, 0.0) the coordinate system
     * origin.
     */
     ...
     */
    public Circle(final double theRadius, final Point2D theCenter, final Color theColor) {
        ...
        /*
         * Note that the Objects class and requireNonNull() were added to Java in
         * version 7. The method will throw an exception if the parameter passed to the
         * method is null. This simplifies the code by eliminating the need for an if /
         * else test and an explicit throws statement.
         */
        ...
        // One way to make a defensive copy is to use a copy constructor if the class
        // has one.
        ...
        // OR
        // We can use the clone() method if the class we want to copy implements
        // Cloneable.
     ...
     * {@inheritDoc}
     * 
     * The String representation of this Circle will be formatted as follows: <br>
     * Circle [radius=(current value), center=(current value), color=(current
     * value)].
     */
    @Override
